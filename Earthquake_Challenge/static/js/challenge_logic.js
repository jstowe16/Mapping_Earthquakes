...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson", function(data) {
  ...
  // This function determines the color of the marker based on the magnitude of the earthquake.
  function getColor(magnitude) { // magnitude less than 5, a magnitude greater than 5, and a magnitude greater than 6.
    if (magnitude > 6) {
      return "red";
    }
    if (magnitude > 5) {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://github.com/fraxen/tectonicplates/tree/master/GeoJSON/PB2002_boundaries.json", function(data) {
  
  // NOTE TO REVIEWER: GITHUB WOULD NOT ALLOW ACCESS TO THIS FILE IN THIS COMMAND. I CAN VIEW IT IN GITHUB, SO INSTEAD
  // COPIED THE CONENT TO A DATA SOURCE FILE.
  // let dataSource = "static/data/PB2002_boundaries.json"
  // d3.json(dataSource, function(data) {
    console.log("plates check");
    console.log(data);
